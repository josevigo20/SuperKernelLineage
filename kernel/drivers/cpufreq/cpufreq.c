...
#define CONFIG_MSM_CPU_FREQ_MIN_GROUP1 200000
#define CONFIG_MSM_CPU_FREQ_MAX_GROUP1 1601600
#define CONFIG_MSM_CPU_FREQ_MIN_GROUP2 200000
#define CONFIG_MSM_CPU_FREQ_MAX_GROUP2 2146000
...
{
	// cores 0..1..2..3 are the little cluster, cores 4..5..6..7 are the big cluster
	if (core < 2)
		return 0;
